...
本章介绍 DMA 内存管理。涵盖的核心知识点包括：DMA 缓冲、一致性内存、流式 DMA。

## 知识点详解

### 1. 核心概念

DMA 内存管理是 Linux 驱动开发中的重要组成部分。本章通过实际代码示例，展示了如何使用 Linux 内核提供的相关 API 进行驱动开发。

**关键 API**：dma_alloc_coherent、dma_map_single、dma_sync_single_for_device
