...
本章介绍 以太网 MAC/PHY 驱动。涵盖的核心知识点包括：MAC 驱动、PHY 驱动、链接状态。

## 知识点详解

### 1. 核心概念

以太网 MAC/PHY 驱动是 Linux 驱动开发中的重要组成部分。本章通过实际代码示例，展示了如何使用 Linux 内核提供的相关 API 进行驱动开发。

**关键 API**：phy_register_driver、phy_connect、phy_start、phy_stop
