...
本章介绍 块设备驱动。涵盖的核心知识点包括：块设备框架、请求队列、分区。

## 知识点详解

### 1. 核心概念

块设备驱动是 Linux 驱动开发中的重要组成部分。本章通过实际代码示例，展示了如何使用 Linux 内核提供的相关 API 进行驱动开发。

**关键 API**：blk_mq_init_sq_queue、blk_queue_make_request、add_disk
